...
for key in List_Net:
    ...
    def train(epoch):
        ...
        writer.add_scalars('ACCURACY', {key + '_Train_ACC': correct * 100. / total}, epoch)

        writer.add_scalars('LOSS FUNCTION', {key + '_Train_LOSS': train_loss / len(trainloader) - 1}, epoch)
    ...
    def test(epoch):
        ...
        with torch.no_grad():
            ...
            writer.add_scalars('ACCURACY', {key + '_Test_ACC': correct * 100. / total}, epoch)

            writer.add_scalars('LOSS FUNCTION', {key + '_Test_LOSS': test_loss / len(testloader) - 1}, epoch)
